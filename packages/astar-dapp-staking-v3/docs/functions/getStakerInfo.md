...
> **getStakerInfo**(`stakerAddress`, `includePreviousPeriods`): `Promise`\<`Map`\<`string`, [`SingularStakingInfo`](../interfaces/SingularStakingInfo.md)\>\>
...
`Promise`\<`Map`\<`string`, [`SingularStakingInfo`](../interfaces/SingularStakingInfo.md)\>\>
